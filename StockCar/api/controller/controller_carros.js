...
const update = (req, res) => {
    ...
    let query = `UPDATE carros SET marca_veiculo = '${marca_veiculo}', modelo_veiculo = '${modelo_veiculo}', ano_veiculo = '${ano_veiculo}', fabricacao_veiculo = '${fabricacao_veiculo}', cliente_id = ${cliente_id} WHERE carros_id = ?`;
